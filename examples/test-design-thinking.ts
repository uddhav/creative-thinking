...
const step1 = {
  ...
  currentStep: 1,
  totalSteps: 5,
  output: 'Understanding user needs: elderly users want simple, intuitive interfaces with large buttons and text. They value seeing family photos and hearing voices clearly.',
  empathyInsights: [
...
const step2 = {
  ...
  output: 'Core problem: Elderly users need a way to maintain meaningful connections with family that feels natural and safe, not intimidating or complex.',
  problemStatement: 'How might we create a communication tool that bridges generational tech gaps while protecting vulnerable users?',
...
const step4 = {
  ...
  totalSteps: 5,
  sessionId: 'session_12345',
  output: 'Built MVP with core features: voice-activated calling, photo sharing, and emergency button.',
  prototypeDescription: 'Simplified tablet interface with 3 main buttons: Call Family, See Photos, Get Help. Voice commands for all actions. Family portal for setup and monitoring.',
  stressTestResults: [
...
const step5 = {
  ...
  totalSteps: 5,
  sessionId: 'session_12345',
  output: 'Tested with 20 elderly users and their families over 2 weeks. Gathered both success stories and failure modes.',
  userFeedback: [
