...
const _concurrentSessionsExample = {
  ...
  session1_step1: {
    ...
    hatColor: 'blue',
    output:
      'Starting with the Blue Hat to organize our thinking process about improving team productivity.',
    nextStepNeeded: true,
  },
  ...
  session1_step2: {
    ...
    hatColor: 'white',
    output:
      'Current facts: 30% time lost in meetings, 25% on context switching, remote work challenges.',
    nextStepNeeded: true,
  },
  ...
  session2_step2: {
    ...
    totalSteps: 4,
    output:
      "Exploring the provocation: What if customers could solve each other's problems? This could lead to community forums, peer recognition systems, and knowledge sharing.",
    nextStepNeeded: true,
  },
