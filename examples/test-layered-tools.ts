...
const discoveryInput = {
  problem: 'How can we improve customer satisfaction while reducing support costs in our technical support department?',
  context: 'We have a growing user base but limited support staff. Response times are increasing and customer satisfaction scores are dropping.',
...
const expectedDiscoveryOutput = {
  ...
  reasoning: 'Based on your problem involving "How can we improve customer satisfaction while reducing support costs in our technical s..." with systematic outcomes, I recommend these techniques.',
