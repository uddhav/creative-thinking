...
export const ANTIFRAGILE_FIELDS = ['antifragileProperties', 'temporalEscapeRoutes'];
...
export function riskEntries(entry) {
    ...
    const projections = record.timelineProjections;
    if (projections) {
...
export function antifragileEntries(entry) {
    const record = entry;
    const entries = [];
