...
export class SessionCleaner {
     ...
     */
    constructor(sessions, planManager, config, memoryManager, touchSession, onTick) {
    ...
    logMemoryMetrics() {
        ...
        const avgSessionSizeKB = this.sessions.size > 0 ? Math.round(totalSessionSize / this.sessions.size / 1024) : 0;
        ...
        if (heapUsagePercent > 0.8) {
            console.error(`[Memory Warning] High heap usage: ${Math.round(heapUsagePercent * 100)}%, considering GC`);
