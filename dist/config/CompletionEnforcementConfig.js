 ...
 */
export function getEnforcementProfile(profileName) {
 ...
 */
export function createCustomEnforcement(overrides) {
 ...
 */
export function loadEnforcementConfigFromEnv() {
 ...
 */
export function validateEnforcementConfig(config) {
    const errors = [];
    // Validate thresholds
...
export function detectProblemType(problem) {
    ...
    if (lowerProblem.includes('creative') ||
...
//# sourceMappingURL=CompletionEnforcementConfig.js.map