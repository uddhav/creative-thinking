...
export class PromptsHandler {
    ...
    getPrompts() {
        return [
            ...
            {
                name: 'red-team-plan',
                description: 'Attack a plan or belief before committing to it: build the opposing case until its holders would sign it, then let a named adversary try to defeat the plan',
                arguments: [
                    {
                        name: 'plan',
                    ...
                    {
                        name: 'who_owns_it',
                        description: 'Who authored or is accountable for it — the independence check needs to know whether that is you',
                        required: false,
                    },
                    {
