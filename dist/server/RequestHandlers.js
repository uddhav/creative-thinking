...
export class RequestHandlers {
    ...
    lateralServer;
    parallelHandler;
    parallelConfig = loadParallelConfig();
    constructor(server, lateralServer) {
        ...
        this.parallelHandler = new ParallelToolCallHandler(lateralServer, this.parallelConfig.maxParallelCalls);
    ...
    setupCallToolHandler() {
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (this.parallelConfig.enabled && this.parallelHandler.isParallelRequest(request.params)) {
                ...
                const result = await this.parallelHandler.processParallelToolCalls(request.params, useAnthropicFormat);
                return {
