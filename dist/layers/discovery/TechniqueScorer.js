...
export class TechniqueScorer {
     ...
     */
    getScoreBreakdown(technique, context, categoryScore) {
        const metadata = this.techniqueMetadata[technique];
        if (!metadata) {
        ...
        const final = factors.categoryFit * this.weights.categoryFit +
            factors.complexityMatch * this.weights.complexityMatch +
            factors.constraintCompatibility * this.weights.constraintCompatibility +
            factors.outcomeAlignment * this.weights.outcomeAlignment;
     ...
     */
    calculateComplexityMatch(techniqueComplexity, problemComplexity) {
     ...
     */
    calculateOutcomeAlignment(metadata, preferredOutcome) {
        if (!preferredOutcome) {
            // No preference = neutral score
            return 0.6;
        }
        const outcomeKey = preferredOutcome;
...
//# sourceMappingURL=TechniqueScorer.js.map