...
export class ExecutionGraphGenerator {
    ...
    static calculateMetadata(nodes) {
        ...
        const sequentialTimeMultiplier = this.calculateSequentialTimeMultiplier(nodes, parallelizableGroups);
        return {
     ...
     */
    static calculateSequentialTimeMultiplier(nodes, rounds) {
    ...
    static canSkipIfFailed(technique) {
        ...
        const independentPerspectiveTechniques = [
            'six_hats',
            'scamper',
            'nine_windows',
        ];
