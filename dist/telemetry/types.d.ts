 ...
 */
export type AnalyticsMetric = 'effectiveness' | 'completion_rate' | 'insight_density' | 'risk_identification_rate' | 'flexibility_preservation' | 'average_duration' | 'user_satisfaction' | 'technique_combinations';
/**
