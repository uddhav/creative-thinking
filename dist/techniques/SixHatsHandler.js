...
export class SixHatsHandler extends BaseTechniqueHandler {
    ...
    getTechniqueInfo() {
        return {
            ...
            parallelSteps: {
                canParallelize: true,
                description: 'All hats can be worn simultaneously by different thinkers or explored in parallel',
            },
        };
    }
    getStepInfo(step) {
        ...
        if (!hatColor) {
            throw new ValidationError(ErrorCode.INVALID_STEP, `Invalid step ${step} for Six Hats technique. Valid steps are 1-${this.hatOrder.length}`, 'step', { providedStep: step, validRange: `1-${this.hatOrder.length}` });
        }
...
//# sourceMappingURL=SixHatsHandler.js.map