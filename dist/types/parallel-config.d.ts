 ...
 */
export declare const DEFAULT_PARTIAL_COMPLETION_CONFIG: PartialCompletionConfig;
export declare const DEFAULT_SYNCHRONIZER_CONFIG: SessionSynchronizerConfig;
export declare const DEFAULT_GROUP_MANAGER_CONFIG: ParallelGroupManagerConfig;
export declare const DEFAULT_SESSION_INDEX_CONFIG: SessionIndexConfig;
export declare const DEFAULT_PROGRESS_TRACKER_CONFIG: ParallelProgressTrackerConfig;
/**
 * Helper function to merge configurations with defaults
 */
export declare function mergeConfig<T>(partial: Partial<T> | undefined, defaults: T): T;
//# sourceMappingURL=parallel-config.d.ts.map