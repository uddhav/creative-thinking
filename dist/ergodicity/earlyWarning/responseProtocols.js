...
export class ResponseProtocolSystem {
     ...
     */
    getPatternInterruptionProtocol() {
        return {
            level: 1,
     ...
     */
    getResourceReallocationProtocol() {
        return {
            level: 2,
     ...
     */
    getTechnicalRefactoringProtocol() {
        return {
            level: 4,
     ...
     */
    executeProtocol(protocol, pathMemory, sessionData, userConfirmation = true) {
     ...
     */
    generateSideEffects(protocol, success, sessionData) {
        const effects = [];
        if (success) {
     ...
     */
    generateNextSteps(protocol, success, sessionData) {
     ...
     */
    generateNewConstraints(protocol, success) {
        if (!success)
            return [];
        const constraints = [];
        switch (protocol.level) {
    ...
    recommendProtocol(warning, pathMemory) {
        ...
        switch (warning.severity) {
            case BarrierWarningLevel.CRITICAL:
                ...
                return viableProtocols.reduce((best, current) => current.level > best.level ? current : best);
     ...
     */
    getEmergencyResponsePlan(warnings, pathMemory) {
...
//# sourceMappingURL=responseProtocols.js.map