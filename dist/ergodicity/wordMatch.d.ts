 ...
 */
export declare function matchesWord(text: string, keyword: string): boolean;
/** True when any keyword matches as a whole word. */
export declare function matchesAnyWord(text: string, keywords: readonly string[]): boolean;
//# sourceMappingURL=wordMatch.d.ts.map