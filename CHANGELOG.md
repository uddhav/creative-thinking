...
- fix: omit optionSpaceSize while no recent step recorded an option, as #327 promised
...
- fix: the five stragglers from the retest, and a version every response can state
