...
export class SessionManager {
  ...
  constructor(samplingManager?: SamplingManager, persistenceAdapter?: PersistenceAdapter) {
    ...
    this.sessionPersistence = new SessionPersistence(persistenceAdapter ?? null);
