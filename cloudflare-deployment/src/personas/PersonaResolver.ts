...
export class PersonaResolver {
  private catalog: Record<string, PersonaDefinition>;
   ...
   */
  private resolveCustom(description: string): PersonaDefinition {
    ...
    let preferredOutcome: PreferredOutcome = 'systematic';
    ...
    const techniqueBias: Partial<Record<LateralTechnique, number>> = {};
