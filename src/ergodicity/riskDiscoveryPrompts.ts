 ...
 */
export function getDiscoveryPhasePrompt(
  ...
  switch (phase) {
    ...
    case 'forced_calculations':
      return getForcedCalculationsPrompt(
        context.proposedAction || '',
        context.previousPhaseOutput || ''
      );
 ...
 */
function getRiskDiscoveryPrompt(problem: string, domainInfo: string): string {
 ...
 */
function getRuinScenarioPrompt(problem: string, risks: string): string {
 ...
 */
function getSafetyPracticesPrompt(domainAndRisks: string): string {
 ...
 */
function getForcedCalculationsPrompt(proposedAction: string, safetyPractices: string): string {
 ...
 * Validation prompt
 */
function getValidationPrompt(proposedAction: string, calculations: string): string {
 ...
 */
export function getMetaDiscoveryPrompt(): string {
 ...
 */
export function isHighRiskDiscovery(response: string): boolean {
...
export function extractHardConstraints(
  discoveryResponses: Record<DiscoveryPhase, string>
): string[] {
 ...
 */
export function generateConstraintViolationFeedback(
  proposedAction: string,
