...
export class KeeperTestHandler extends BaseTechniqueHandler {
  ...
  getTechniqueInfo(): TechniqueInfo {
    return {
      ...
      totalSteps: 5,
      description:
        'Re-decides something already in place by asking whether you would take it on today, rather than whether it has failed badly enough to remove',
      focus: 'Move the burden of proof onto retention instead of removal',
      enhancedFocus:
        'Separates carrying cost from switching cost, strikes out sunk cost, and ends in a verdict with a tripwire rather than an opinion',
      parallelSteps: {
        canParallelize: false,
        description:
          'Sequential: the fence must be reconstructed before the re-acquisition question can be answered honestly',
      },
      reflexivityProfile: {
