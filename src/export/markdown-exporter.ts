...
import { ExportOptions, ExportResult, DEFAULT_MARKDOWN_TEMPLATE } from './types.js';
...
export class MarkdownExporter extends BaseExporter {
  ...
  private formatHistoryEntry(entry: LateralThinkingInput, timestamp: string, stepNumber: number, technique: string): string {
    const lines: string[] = [];
