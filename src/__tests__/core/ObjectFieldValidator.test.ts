...
describe('ObjectFieldValidator', () => {
  ...
  describe('validateParallelResultItem', () => {
    it('should accept valid parallel result', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-123',
          technique: 'six_hats',
          results: { output: 'test' },
    ...
    it('should accept parallel result without optional fields', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-456',
          technique: 'scamper',
    ...
    it('should reject parallel result missing planId', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          technique: 'six_hats',
        },
    ...
    it('should reject parallel result missing technique', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-789',
        },
    ...
    it('should reject parallel result with non-object results', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-123',
          technique: 'six_hats',
      ...
      expect(result.isValid).toBe(false);
      expect(result.error).toContain('parallelResults[0].results');
    });

    it('should reject parallel result with non-object metrics', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-123',
          technique: 'six_hats',
      ...
      expect(result.isValid).toBe(false);
      expect(result.error).toContain('parallelResults[0].metrics');
    });

    it('should reject parallel result with non-array insights', () => {
      const result = ObjectFieldValidator.validateParallelResultItem(
        {
          planId: 'plan-123',
          technique: 'six_hats',
