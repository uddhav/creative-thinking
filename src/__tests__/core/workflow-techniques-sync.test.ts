...
describe('WorkflowGuard Techniques Synchronization', () => {
  it('should have all techniques from TechniqueRegistry in validTechniques', () => {
    ...
    // Also verify the count matches what we expect (28 techniques with behavioral economics)
    expect(registeredTechniques.length).toBe(28);
    expect(validTechniques.length).toBe(28);
    ...
    expect(validTechniques).toContain('cultural_integration');
