...
describe('WorkflowGuard PlanId Validation', () => {
  ...
  it('should accept execute_thinking_step with valid planId even without recent calls', async () => {
  ...
  it('should reject execute_thinking_step with invalid planId and no recent calls', async () => {
  ...
  it('should accept execute_thinking_step after recording discovery and planning', async () => {
  ...
  it('should handle missing SessionManager gracefully', async () => {
    ...
    const violation = await guardWithoutManager.checkWorkflowViolation(
  ...
  it('should validate technique even with valid planId', async () => {
