  ...
  getPrompts(): Prompt[] {
    return [
      ...
      },
      {
        ...
        arguments: [
          ...
          },
          {
            name: 'persona',
            description:
              'Thinking personality: rory_sutherland, rich_hickey, joe_armstrong, tarantino, security_engineer, veritasium, design_thinker, nassim_taleb, charlie_munger, or custom:description',
            required: true,
          },
          {
            name: 'depth',
      ...
      },
      {
        ...
        description:
          "Run Charlie Munger's checklist of standard causes of human misjudgment on a decision, then invert it",
        arguments: [
          {
            name: 'problem',
          ...
          },
          {
            ...
            description:
              'Comma-separated tendencies to focus on (e.g., "incentive-caused bias, social proof, deprival super-reaction"). Leave empty for automatic selection',
            required: false,
          },
        ] as PromptArgument[],
      },
      {
        name: 'invert-problem',
        description:
          'Apply inversion ("invert, always invert") — find everything that would guarantee failure, then design to avoid it',
        arguments: [
          {
            name: 'problem',
          ...
          },
          {
            ...
            description:
              'What success looks like, so it can be inverted into concrete failure modes',
            required: false,
          },
        ] as PromptArgument[],
      },
      {
        name: 'keeper-test',
        description:
          'Re-decide something already in place — a role, a team, a library, a subscription — by asking whether you would take it on today rather than whether it has failed badly enough to remove',
        arguments: [
          {
            name: 'incumbent',
            description:
              'The thing being re-decided. Name the unit that would actually stop if you said no',
            required: true,
          },
          {
            name: 'cost_per_period',
            description:
              'What one more period of keeping it costs in money, attention and calendar',
            required: false,
          },
          {
            name: 'alternatives',
