...
export class ErrorContextBuilder {
   ...
   */
  buildWorkflowError(
    errorType: 'plan_not_found' | 'technique_mismatch',
   ...
   */
  private buildPlanNotFoundError(planId: string): LateralThinkingResponse {
    return {
      content: [
        {
          type: 'text',
   ...
   */
  private buildTechniqueMismatchError(context: WorkflowErrorContext): LateralThinkingResponse {
