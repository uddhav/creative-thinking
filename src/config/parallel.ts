 ...
 */
export function loadParallelConfig(): ExecutionConfig {
 ...
 */
export function validateParallelConfig(config: ExecutionConfig): string[] {
  const errors: string[] = [];
 ...
 */
export function getExecutionConfigSummary(config: ExecutionConfig): string {
