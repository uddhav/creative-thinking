 ...
 */
export const defaultParallelismConfig: ParallelismConfig = {
  keywords: {
    parallel: [
 ...
 */
export function mergeParallelismConfig(custom?: Partial<ParallelismConfig>): ParallelismConfig {
  if (!custom) return defaultParallelismConfig;
